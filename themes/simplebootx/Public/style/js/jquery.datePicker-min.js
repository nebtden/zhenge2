        ...
        renderCalendar: function(t) {
            ...
            while (n++<q) {
             ...
             //       var y = d(C("td")).html("<div class=\"td_td \" da=\""+m+"\"><span>"+m.getDate() + ""+"</span></div>").addClass((j ? "current-month ": "other-month ") + (m.isWeekend() ? "weekend ": "weekday ") + (j && m.getTime() == z.getTime() ? "today ": "")).data("datePickerDate", m.asString()).hover(A(k), g);
                    var y = d(C("td")).html("<div class=\"td_td \" da=\""+m+"\"><span>"+(j && m.getTime() == z.getTime() ? "今 ": m.getDate())+"</span></div>").addClass((j ? "current-month ": "other-month ") + (m.isWeekend() ? "weekend ": "weekday ") + (j && m.getTime() == z.getTime() ? "today ": "")).data("datePickerDate", m.asString()).hover(A(k), g);
